...
def run():
	...
	"""
	parser = argparse.ArgumentParser(description="program to mask by kmers")
	parser.add_argument("-i", "--input", help="path to input data file",dest="input", type=str, required=True)
	parser.add_argument("-o", "--output", help="path to output file", dest="output",type=str, required=True)
	parser.add_argument("-k", "--kmer", help="path to kmer file", dest="kmer",type=str, required=True)
	parser.add_argument("-u", "--unmask", help="if unmask first", dest="unmask",type=int, default = 1)
	parser.add_argument("-H", "--hardmask", help="if unmask first", dest="hardmask",type=int, default = 0)
